    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="app">
        ...
        <div class="form-group">
            <label>Subject</label>
            <input type="text" name="name_of_subject" class="form-control" required="">
        </div>
          <div class="form-group">
      ...
      <div class="form-group">
        <label>Grade (working at)</label>
          ...
          <textarea name="current_grade" class="form-control" placeholder="currently working at grade" required=""></textarea>
    </div>
